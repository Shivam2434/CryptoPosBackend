...
import {
    IsEmail, IsString, MinLength, IsOptional, IsArray, IsIn,
    Matches,
...
export class CreateMerchantDto {
    ...
    @ApiPropertyOptional({ example: '0x742d35Cc6634C0532925a3b844Bc9e7595f2bD68' })
    @IsOptional()
    @IsString()
    ethWalletAddress?: string;

    @ApiPropertyOptional({ example: 'bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh' })
    @IsOptional()
    @IsString()
