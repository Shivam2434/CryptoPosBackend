...
export class DevicesService {
    ...
    async register(organizationId: string, dto: RegisterDeviceDto): Promise<{ device: Device; pairingCode: string }> {
    ...
    async pair(dto: PairDeviceDto): Promise<{ device: Device; deviceToken: string }> {
    ...
    async findAll(organizationId: string, locationId?: string): Promise<Device[]> {
    ...
    async revoke(organizationId: string, id: string): Promise<{ success: boolean }> {
        const device = await this.findById(organizationId, id);
