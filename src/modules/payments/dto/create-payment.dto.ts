...
export class CreatePaymentDto {
  @ApiProperty({
    example: 15.5,
    description: 'Amount in AUD to charge customer',
  })
  @IsNumber()
  @Min(0.01)
  @Max(10000000)
  ...
  @ApiPropertyOptional({
    example: 'ORDER-001',
    description: 'Merchant internal invoice or POS order ID',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    description: 'POS Terminal register UUID',
  })
  @IsOptional()
  @IsUUID()
  deviceId?: string;
  ...
  @ApiPropertyOptional({
    example: { customerEmail: 'payer@example.com', taxRate: 0.1 },
  })
  @IsOptional()
  @IsObject()
