...
describe('PaymentsService', () => {
    ...
    beforeEach(async () => {
        paymentsRepo = {
            create: jest.fn().mockImplementation((dto) => ({ id: 'payment-uuid-1', ...dto })),
    ...
    it('should create a new payment with QR code and address when idempotencyKey is new', async () => {
        ...
        expect(result.paymentAddress).toBe('0x742d35Cc6634C0532925a3b844Bc9e7595f2bD68');
