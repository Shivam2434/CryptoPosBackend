...
export class AuthController {
    ...
    @ApiResponse({ status: 200, description: 'Current user profile and organization details' })
    ...
    @ApiResponse({ status: 200, description: 'Synchronized user profile and tenant context' })
    async syncProfile(
    ...
    @ApiOperation({
        ...
        description: 'Deprecated in favor of third-party identity provider sign up.',
        deprecated: true,
    })
    ...
    @ApiOperation({
        ...
        description: 'Deprecated in favor of third-party identity provider Bearer tokens.',
        deprecated: true,
    })
