...
export class JwtStrategy extends PassportStrategy(Strategy) {
    constructor(
        ...
        super({
            ...
            secretOrKey: config.get<string>('app.jwtSecret') || 'crypto-pos-dev-secret-change-in-production-min-32-chars',
        });
    }

    async validate(payload: { sub: string; email: string; orgId?: string }): Promise<AuthContext> {
