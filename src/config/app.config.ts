...
export const appConfig = registerAs('app', () => ({
    ...
    jwtSecret: process.env.JWT_SECRET || 'crypto-pos-dev-secret-change-in-production-min-32-chars',
    jwtExpiresIn: process.env.JWT_EXPIRES_IN || '24h',
    environment: process.env.NODE_ENV || 'development',
    webhookSecret: process.env.WEBHOOK_SECRET || 'whsec_default_secret_key_change_me',
...
export const authConfig = registerAs('auth', () => ({
    ...
    mockSecret: process.env.AUTH_MOCK_SECRET || 'crypto-pos-mock-jwt-secret-for-dev',
}));

export const blockchainConfig = registerAs('blockchain', () => ({
    ethereum: {
        rpcUrl: process.env.ETH_RPC_URL || 'https://ethereum-rpc.publicnode.com',
        sepoliaRpcUrl: process.env.ETH_SEPOLIA_RPC_URL || 'https://ethereum-sepolia-rpc.publicnode.com',
        ...
        sepoliaUsdtContractAddress: process.env.SEPOLIA_USDT_CONTRACT_ADDRESS || '0x7169D38820dfd117C3FA1f22a697dBA58d90BA06',
        sepoliaUsdcContractAddress: process.env.SEPOLIA_USDC_CONTRACT_ADDRESS || '0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238',
    },
    bitcoin: {
        apiUrl: process.env.BTC_API_URL || 'https://blockstream.info/api',
        testnetApiUrl: process.env.BTC_TESTNET_API_URL || 'https://blockstream.info/testnet/api',
    ...
    confirmationsRequired: {
        ...
        USDT_ERC20: process.env.USDT_CONFIRMATIONS ? parseInt(process.env.USDT_CONFIRMATIONS, 10) : 2,
        USDC_ERC20: process.env.USDC_CONFIRMATIONS ? parseInt(process.env.USDC_CONFIRMATIONS, 10) : 2,
    },
}));
